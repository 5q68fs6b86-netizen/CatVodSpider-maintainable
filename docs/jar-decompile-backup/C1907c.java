...
/* JADX INFO: renamed from: com.github.catvod.spider.support.p044FM.p096u.c */
...
final class C1907c {
    ...
    static /* synthetic */ Class f4384b;

    static {
        try {
            f4383a = System.getProperty("xml.stream.debug") != null;
        } catch (Exception unused) {
        }
    }

    /* JADX INFO: renamed from: a */
    static /* synthetic */ Class m4611a() {
        return C1907c.class;
    }

    /* JADX INFO: renamed from: b */
    private static void m4612b(String str) {
        if (f4383a) {
    ...
    /* JADX WARN: Code duplicated, block: B:17:0x004c A[PHI: r2
      0x004c: PHI (r2v2 java.lang.Class<com.github.catvod.spider.support.p044FM.p096u.c>) = 
      (r2v0 java.lang.Class<com.github.catvod.spider.support.p044FM.p096u.c>)
      (r2v3 java.lang.Class<com.github.catvod.spider.support.p044FM.p096u.c>)
     binds: [B:15:0x0044, B:12:0x003f] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX INFO: renamed from: c */
    static Object m4613c() {
        Class<C1907c> cls;
        ClassLoader classLoader;
        Class<C1907c> cls2 = C1907c.class;
        try {
            StringBuffer stringBuffer = new StringBuffer();
            Class<C1907c> cls3 = f4384b;
            if (cls3 == null) {
                m4611a();
                f4384b = cls2;
                cls3 = cls2;
            ...
            classLoader = ((AbstractC1906b) Class.forName(stringBuffer.toString()).newInstance()).m4610a();
        ...
        try {
            ...
            if (property != null) {
                ...
                m4612b(stringBuffer2.toString());
                return m4614d(property, classLoader);
            }
        ...
        try {
            ...
            if (file.exists()) {
                ...
                if (property3 != null && property3.length() > 0) {
                    ...
                    m4612b(stringBuffer4.toString());
                    return m4614d(property3, classLoader);
                }
            }
        } catch (Exception e2) {
            if (f4383a) {
        ...
        try {
            ...
            if (systemResourceAsStream != null) {
                ...
                if (line != null && !"".equals(line)) {
                    ...
                    m4612b(stringBuffer6.toString());
                    return m4614d(line, classLoader);
                }
            }
        } catch (Exception e3) {
            if (f4383a) {
        ...
        m4612b("loaded from fallback value: com.bea.xml.stream.MXParserFactory");
        return m4614d("com.bea.xml.stream.MXParserFactory", classLoader);
    }

    /* JADX INFO: renamed from: d */
    private static Object m4614d(String str, ClassLoader classLoader) {
        try {
            ...
            throw new C1905a(stringBuffer.toString(), e);
        } catch (Exception e2) {
            StringBuffer stringBuffer2 = new StringBuffer();
            ...
            throw new C1905a(stringBuffer2.toString(), e2);
        }
    }
}
