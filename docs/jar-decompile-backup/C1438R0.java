...
/* JADX INFO: renamed from: com.github.catvod.spider.support.p044FM.p056L.R0 */
/* JADX INFO: loaded from: classes.dex */
final class C1438R0 extends EnumC1484j1 {
    C1438R0() {
    ...
    final void mo3531g(C1441T c1441t, C1455a c1455a) {
        ...
        if (cM3662f == '\t' || cM3662f == '\n' || cM3662f == '\f' || cM3662f == '\r' || cM3662f == ' ') {
            enumC1484j1 = EnumC1484j1.f3430d0;
        } else if (cM3662f == '\"') {
            c1441t.m3632r(this);
            enumC1484j1 = EnumC1484j1.f3432e0;
        } else {
            if (cM3662f != '\'') {
                if (cM3662f == '>') {
                    c1441t.m3632r(this);
            ...
            c1441t.m3632r(this);
            enumC1484j1 = EnumC1484j1.f3434f0;
        }
