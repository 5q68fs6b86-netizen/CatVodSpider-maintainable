...
public class JianPian extends Spider {
    ...
    /* JADX INFO: renamed from: com.github.catvod.spider.JianPian$1 */
    class C00461 extends AbstractC0763ya {
    ...
    public final String m579c(String str) {
        try {
            if (!str.startsWith("/")) {
                return str;
            }
            return "https://" + this.f209b + str;
        } catch (Exception e) {
            e.printStackTrace();
            return str;
        }
    ...
    public String categoryContent(String str, String str2, boolean z, HashMap<String, String> map) {
        try {
            String strReplace = (str.equals("67") ? this.f208a + "/api/crumb/shortList?fcate_pid={cateId}&category_id={category_id}&sort=update&page={page}" : this.f208a + "/api/crumb/list?fcate_pid={cateId}&category_id={category_id}&area={area}&year={year}&type={type}&sort={sort}&page={page}").replace("{page}", str2).replace("{cateId}", str);
            ...
            String strM1889k = AbstractC0771yi.m1889k(strReplace2, m580d(this.f208a));
            JSONObject jSONObject = new JSONObject();
            JSONArray jSONArray = new JSONArray();
            JSONArray jSONArray2 = new JSONObject(strM1889k).getJSONArray("data");
            for (int i = 0; i < jSONArray2.length(); i++) {
                JSONObject jSONObject2 = jSONArray2.getJSONObject(i);
                String string = jSONObject2.getString("title");
                String strM579c = str.equals("67") ? m579c(jSONObject2.getString("cover_image")) : m579c(jSONObject2.getString("path"));
                ...
                jSONObject3.put("vod_id", numValueOf + "$$$" + string + "$$$" + strM579c + "$$$" + str);
                jSONObject3.put("vod_name", string);
                jSONObject3.put("vod_pic", strM579c);
    ...
    public final HashMap m580d(String str) {
        return AbstractC0710wb.m1762f("User-Agent", "Mozilla/5.0 (Linux; Android 7.1.2; V2049A Build/UP1A.231005.007; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/81.0.4044.117 Mobile Safari/537.36;webank/h5face;webank/1.0;netType:NETWORK_WIFI;appVersion:422;packageName:com.jp3.xg3");
    }
    ...
    public String detailContent(List<String> list) {
        ...
        try {
            ...
            String str5 = this.f208a + "/api/video/detailv2?id=" + strArrSplit[0];
            if (strArrSplit[3].equals("67")) {
                str5 = this.f208a + "/api/detail?vid=" + strArrSplit[0];
            }
            JSONObject jSONObject2 = new JSONObject(AbstractC0771yi.m1889k(str5, m580d(this.f208a))).getJSONObject("data");
            jSONObject.put("vod_id", list.get(0));
            jSONObject.put("vod_name", strArrSplit[1]);
            jSONObject.put("vod_pic", m579c(strArrSplit[2]));
            ...
            if (strArrSplit[3].equals("67")) {
                ...
                while (true) {
                    ...
                    arrayList4.add(jSONArray2.getJSONObject(i).get("name"));
                    i++;
                    str4 = str;
                }
                ...
                if (jSONObject2.has("source_list_source") && (jSONObject2.get("source_list_source") instanceof JSONArray)) {
                    JSONArray jSONArray3 = jSONObject2.getJSONArray("source_list_source");
                    int i2 = 0;
                    while (i2 < jSONArray3.length()) {
                        String string3 = jSONArray3.getJSONObject(i2).getString(str2);
                        JSONArray jSONArray4 = jSONArray3.getJSONObject(i2).getJSONArray("source_list");
                        ...
                        while (i3 < jSONArray4.length()) {
                            ...
                            if (strOptString4.isEmpty()) {
                                ...
                                if (strOptString4.startsWith("ftp")) {
                                    strOptString4 = "tvbox-xg:" + strOptString4;
                                }
            ...
            jSONObject5.put("list", jSONArray6);
    ...
    public String homeVideoContent() {
        try {
            String strM1889k = AbstractC0771yi.m1889k(this.f208a + "/api/dyTag/list?category_id=88", m580d(this.f208a));
            JSONObject jSONObject = new JSONObject();
            JSONArray jSONArray = new JSONArray();
            JSONArray jSONArray2 = new JSONObject(strM1889k).getJSONArray("data");
            for (int i = 0; i < jSONArray2.length(); i++) {
                ...
                for (int i2 = 0; i2 < jSONArray3.length(); i2++) {
                    ...
                    String string = jSONObject2.getString("title");
                    String strM579c = m579c(jSONObject2.getString("path"));
                    String string2 = jSONObject2.getString("mask");
                    Integer numValueOf = Integer.valueOf(jSONObject2.getInt("id"));
                    JSONObject jSONObject3 = new JSONObject();
                    jSONObject3.put("vod_id", numValueOf + "$$$" + string + "$$$" + strM579c + "$$$1");
                    jSONObject3.put("vod_name", string);
                    jSONObject3.put("vod_pic", strM579c);
                    jSONObject3.put("vod_remarks", string2);
                    jSONArray.put(jSONObject3);
    ...
    public void init(Context context) {
        super.init(context);
        try {
            String[] strArrSplit = new JSONObject(AbstractC0771yi.m1889k("https://dns.alidns.com/resolve?name=swrdsfeiujo25sw.cc&type=TXT", null)).getJSONArray("Answer").getJSONObject(0).getString("data").replaceAll("^\"|\"$", "").split(",");
            boolean z = false;
            for (String str : strArrSplit) {
                String strAaaa = aaaa(str);
                C00461 c00461 = new C00461();
                AbstractC0771yi.m1885g(AbstractC0771yi.m1884f(), strAaaa, null, c00461);
                if (((Response) c00461.getResult()).code() == 200) {
                    this.f208a = strAaaa;
                    z = true;
                    break;
                }
            ...
            if (!z) {
                this.f208a = aaaa(strArrSplit[0]);
            }
            this.f209b = new JSONObject(AbstractC0771yi.m1889k(this.f208a + "/api/v2/settings/resourceDomainConfig", null)).getJSONObject("data").getString("imgDomain").split(",")[1];
        } catch (Exception e) {
            SpiderDebug.log(e);
        }
    }
    ...
    public String playerContent(String str, String str2, List<String> list) {
        try {
            JSONObject jSONObject = new JSONObject();
            if (AbstractC0405ku.m1362f(str2) && str2.startsWith("http")) {
    ...
    public String searchContent(String str, boolean z) {
        try {
            String strM1889k = AbstractC0771yi.m1889k(this.f208a + "/api/v2/search/videoV2?key=" + URLEncoder.encode(str) + "&category_id=88&page=1&pageSize=20", m580d(this.f208a));
            JSONObject jSONObject = new JSONObject();
            JSONArray jSONArray = new JSONArray();
            JSONArray jSONArray2 = new JSONObject(strM1889k).getJSONArray("data");
            for (int i = 0; i < jSONArray2.length(); i++) {
                JSONObject jSONObject2 = jSONArray2.getJSONObject(i);
                String string = jSONObject2.getString("title");
                String strM579c = m579c(jSONObject2.getString("thumbnail"));
                String string2 = jSONObject2.getString("mask");
                Integer numValueOf = Integer.valueOf(jSONObject2.getInt("id"));
                Integer numValueOf2 = Integer.valueOf(jSONObject2.getJSONObject("top_category").getInt("id"));
                JSONObject jSONObject3 = new JSONObject();
                jSONObject3.put("vod_id", numValueOf + "$$$" + string + "$$$" + strM579c + "$$$" + numValueOf2);
                jSONObject3.put("vod_name", string);
                jSONObject3.put("vod_pic", strM579c);
                jSONObject3.put("vod_remarks", string2);
                jSONArray.put(jSONObject3);
