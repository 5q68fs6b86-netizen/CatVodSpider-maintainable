...
import com.github.catvod.spider.support.p102H.C2045a;
...
/* JADX INFO: renamed from: com.github.catvod.spider.support.p101G.j */
/* JADX INFO: loaded from: classes.dex */
public final class C2038j {

    /* JADX INFO: renamed from: a */
    private static final char[] f4635a = {',', ';'};

    /* JADX INFO: renamed from: b */
    private static final HashMap<String, String> f4636b = new HashMap<>();

    /* JADX INFO: renamed from: com.github.catvod.spider.support.p101G.j$a */
    public enum a {
        ...
        a(String str, int i) {
            C2038j.m4906a(this, str, i);
        }

        /* JADX INFO: renamed from: i */
        final int m4920i(String str) {
            int iBinarySearch = Arrays.binarySearch(this.f4641a, str);
            if (iBinarySearch >= 0) {
                return this.f4642b[iBinarySearch];
            }
            return -1;
        }

        /* JADX INFO: renamed from: j */
        final String m4921j(int i) {
            int iBinarySearch = Arrays.binarySearch(this.f4643c, i);
            if (iBinarySearch < 0) {
                return "";
            }
            String[] strArr = this.f4644d;
    ...
    /* JADX INFO: renamed from: a */
    static void m4906a(a aVar, String str, int i) {
        int i2;
        aVar.f4641a = new String[i];
        aVar.f4642b = new int[i];
        aVar.f4643c = new int[i];
        aVar.f4644d = new String[i];
        C2045a c2045a = new C2045a(new StringReader(str), str.length());
        int i3 = 0;
        while (!c2045a.m4990w()) {
            try {
                String strM4983p = c2045a.m4983p('=');
                c2045a.m4970a();
                int i4 = Integer.parseInt(c2045a.m4984q(f4635a), 36);
                char cM4988u = c2045a.m4988u();
                c2045a.m4970a();
                if (cM4988u == ',') {
                    i2 = Integer.parseInt(c2045a.m4983p(';'), 36);
                    c2045a.m4970a();
                } else {
                    i2 = -1;
                }
                int i5 = Integer.parseInt(c2045a.m4983p('&'), 36);
                c2045a.m4970a();
                aVar.f4641a[i3] = strM4983p;
                aVar.f4642b[i3] = i4;
                aVar.f4643c[i5] = i4;
                aVar.f4644d[i5] = strM4983p;
                if (i2 != -1) {
                    f4636b.put(strM4983p, new String(new int[]{i4, i2}, 0, 2));
                }
                i3++;
            } catch (Throwable th) {
                c2045a.m4971d();
        ...
        C1271c.m3154d(i3 == i, "Unexpected count of entities loaded");
        c2045a.m4971d();
    }

    /* JADX INFO: renamed from: b */
    private static void m4907b(Appendable appendable, a aVar, int i) throws IOException {
        Appendable appendableAppend;
        String strM4921j = aVar.m4921j(i);
        if ("".equals(strM4921j)) {
            appendableAppend = appendable.append("&#x");
            strM4921j = Integer.toHexString(i);
        } else {
            appendableAppend = appendable.append('&');
        }
        appendableAppend.append(strM4921j).append(';');
    }

    /* JADX INFO: renamed from: c */
    public static int m4908c(String str, int[] iArr) {
        ...
        int iM4920i = a.extended.m4920i(str);
        if (iM4920i == -1) {
            return 0;
        }
        iArr[0] = iM4920i;
    ...
    /* JADX INFO: renamed from: d */
    static void m4909d(Appendable appendable, String str, C2034f.a aVar, boolean z, boolean z2, boolean z3, boolean z4) throws IOException {
        String str2;
        char c;
        int iM6255a;
        a aVarM4850c = aVar.m4850c();
        CharsetEncoder charsetEncoderM4849b = aVar.m4849b();
        int i = aVar.f4621d;
            ...
            if (z2) {
                if (!C1274b.m3174e(iCodePointAt)) {
                    ...
                    if (iCodePointAt < 65536) {
                        ...
                        if (c != '\t') {
                            if (c != '\"') {
                                if (c != '&') {
                                    ...
                                    if (c != 160) {
                                        if (c >= ' ') {
                                            iM6255a = C2314g.m6255a(i);
                                            if (iM6255a != 0) {
                                                if (iM6255a != 1) {
                                                    zCanEncode = charsetEncoderM4849b.canEncode(c);
                                                }
                                            } else if (c >= 128) {
                                                zCanEncode = false;
                                            }
                                        ...
                                        m4907b(appendable, aVarM4850c, iCodePointAt);
                                    } else if (aVarM4850c != a.xhtml) {
                                        str2 = "&nbsp;";
                                    } else {
                                        str2 = "&#xa0;";
                                    }
                        ...
                        if (charsetEncoderM4849b.canEncode(str2)) {
                            appendable.append(str2);
                        } else {
                            m4907b(appendable, aVarM4850c, iCodePointAt);
                        }
                ...
                if (c != '\t' && c != '\n' && c != '\r') {
                    if (c != '\"') {
                        ...
                        } else if (z || aVarM4850c == a.xhtml || aVar.m4855h() == 2) {
                            str2 = "&lt;";
                        }
                        appendable.append(str2);
                    } else if (z) {
    ...
    public static boolean m4910e(String str) {
        return a.base.m4920i(str) != -1;
    }

    /* JADX INFO: renamed from: f */
    public static boolean m4911f(String str) {
        return a.extended.m4920i(str) != -1;
    }
}
