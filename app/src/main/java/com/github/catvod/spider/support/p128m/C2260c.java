...
public final class C2260c {
    ...
    public static String m6138a(String str, String str2) throws BadPaddingException, NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeyException {
    ...
    private static String m6139b(String str) {
        try {
    ...
    private static String m6140c(String str) {
        try {
            if (TextUtils.isEmpty(str)) {
                return "";
            }
