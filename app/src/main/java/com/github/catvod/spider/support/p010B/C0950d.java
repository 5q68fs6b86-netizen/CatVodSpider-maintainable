...
public final class C0950d {
    ...
    private static final String[][] f2237b;

    /* JADX INFO: renamed from: c */
    private static final String[][] f2238c;

    /* JADX INFO: renamed from: d */
    private static final String[][] f2239d;

    /* JADX INFO: renamed from: e */
    private static final String[][] f2240e;

    /* JADX INFO: renamed from: f */
    private static final String[][] f2241f;

    /* JADX INFO: renamed from: g */
    private static final String[][] f2242g;

    /* JADX INFO: renamed from: h */
    private static final String[][] f2243h;

    /* JADX INFO: renamed from: i */
    private static final String[][] f2244i;

    /* JADX INFO: renamed from: j */
    private static final String[][] f2245j;
    ...
    static {
        ...
        f2238c = strArr2;
        f2239d = m2329k(strArr2);
        String[][] strArr3 = {new String[]{"\"", "&quot;"}, new String[]{"&", "&amp;"}, new String[]{"<", "&lt;"}, new String[]{">", "&gt;"}};
        f2240e = strArr3;
        f2241f = m2329k(strArr3);
        String[][] strArr4 = {new String[]{"'", "&apos;"}};
        f2242g = strArr4;
        f2243h = m2329k(strArr4);
        String[][] strArr5 = {new String[]{"\b", "\\b"}, new String[]{"\n", "\\n"}, new String[]{"\t", "\\t"}, new String[]{"\f", "\\f"}, new String[]{"\r", "\\r"}};
        f2244i = strArr5;
        f2245j = m2329k(strArr5);
    }

    /* JADX INFO: renamed from: a */
    public static String[][] m2319a() {
        return (String[][]) f2242g.clone();
    }

    /* JADX INFO: renamed from: b */
    public static String[][] m2320b() {
        return (String[][]) f2243h.clone();
    }

    /* JADX INFO: renamed from: c */
    public static String[][] m2321c() {
        return (String[][]) f2240e.clone();
    }

    /* JADX INFO: renamed from: d */
    public static String[][] m2322d() {
        return (String[][]) f2241f.clone();
    }

    /* JADX INFO: renamed from: e */
    public static String[][] m2323e() {
        return (String[][]) f2238c.clone();
    }

    /* JADX INFO: renamed from: f */
    public static String[][] m2324f() {
        return (String[][]) f2239d.clone();
    }

    /* JADX INFO: renamed from: g */
    public static String[][] m2325g() {
        return (String[][]) f2236a.clone();
    }

    /* JADX INFO: renamed from: h */
    public static String[][] m2326h() {
        return (String[][]) f2237b.clone();
    }

    /* JADX INFO: renamed from: i */
    public static String[][] m2327i() {
        return (String[][]) f2244i.clone();
    }

    /* JADX INFO: renamed from: j */
    public static String[][] m2328j() {
        return (String[][]) f2245j.clone();
    }

    /* JADX INFO: renamed from: k */
    public static String[][] m2329k(String[][] strArr) {
