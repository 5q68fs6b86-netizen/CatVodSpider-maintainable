...
public class C2626 {
    ...
    public static String m6816(short[] sArr, int i, int i2, int i3) {
    ...
    public static int m6817() {
        return (-236) ^ C2610.f6148;
    }
}
