...
public class PanUC extends Pan {
    ...
    private C2144B f243h;

    /* JADX INFO: renamed from: i */
    public ProgressDialog f244i;

    /* JADX INFO: renamed from: j */
    public boolean f245j;

    /* JADX INFO: renamed from: b */
    private void m615b(String str, String str2, List<Vod> list, boolean z, boolean z2) {
        ArrayList<C2223a> arrayList = new ArrayList();
        if (z) {
            this.f243h.m5444p(str2, arrayList);
        } else {
            this.f243h.m5447s(str);
            this.f243h.m5449u(str, str2, 1, arrayList);
        }
    ...
    public String action(String str) {
        try {
            ...
            Init.run(new Runnable() { // from class: com.github.catvod.spider.PanUC.3
                ...
                public void run() {
                    try {
                        ...
                        panUC.f244i = progressDialog;
                        progressDialog.setProgressStyle(1);
                        PanUC.this.f244i.setMax(100);
                        PanUC.this.f244i.setCancelable(false);
                        if (PanUC.this.isBusy()) {
                            PanUC.this.f244i.show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
            ...
            Response responseExecute = new OkHttpClient().newCall(new Request.Builder().url(this.f243h.m5446qq(new String[]{jSONObjectOptJSONObject.optString("folder"), jSONObjectOptJSONObject.optString("shareId"), jSONObjectOptJSONObject.optString("fileToken")}, "我的UC原画")).build()).execute();
            ...
            while (true) {
                ...
                Init.run(new Runnable() { // from class: com.github.catvod.spider.PanUC.4
                    ...
                    public void run() {
                        try {
                            if (PanUC.this.f244i != null) {
                                PanUC.this.f244i.setProgress(i2);
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
    ...
    public String categoryContent(String str, String str2, boolean z, HashMap<String, String> map) {
        try {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                m615b(strOptString, strOptString2, arrayList, TextUtils.isEmpty(strOptString), false);
            }
    ...
    public String detailContent(List<String> list) {
        ...
        c2194e.m5849k("");
        c2194e.m5850l("https://image.uc.cn/s/uae/g/3o/broccoli/resource/202312/f3868960-9255-11ee-b5b0-eb0fcd1347fe.png");
        c2194e.m5851m(TextUtils.join("$$$", Config.getMyUCOptions()));
        ArrayList arrayList = new ArrayList();
        ArrayList arrayList2 = new ArrayList();
        ArrayList<Vod> arrayList3 = new ArrayList();
        m615b(strOptString, strOptString2, arrayList3, TextUtils.isEmpty(strOptString), true);
        ...
        for (int i = 0; i < Config.getMyUCOptions().size(); i++) {
    ...
    public String homeContent(boolean z) {
        ArrayList arrayList = new ArrayList();
        try {
            JSONArray jSONArray = new JSONArray("[{\"name\":\"我的UC网盘\",\"folders\":[{\"shareId\":\"\",\"folder\":\"0\"}]},{\"name\":\"软件商店\",\"folders\":[{\"shareId\":\"ba531661b3eb4\",\"folder\":\"0\"},{\"shareId\":\"e7b5fd4698704\",\"folder\":\"0\"}]}]");
            C2144B c2144b = this.f243h;
            if (c2144b == null || TextUtils.isEmpty(c2144b.m5439j())) {
                arrayList.add(new Class("0", "还未登录UC账号,请前往【配置中心】登录", "1"));
            } else {
                for (int i = 0; i < jSONArray.length(); i++) {
                    JSONObject jSONObjectOptJSONObject = jSONArray.optJSONObject(i);
