...
/* JADX INFO: renamed from: com.github.catvod.spider.support.A0.jt */
/* JADX INFO: loaded from: classes.dex */
public static final class C0377jt extends EnumC0709wa {
    public C0377jt() {
        super("Rcdata", 2);
    }
    ...
    public final void mo870a(C0316hm c0316hm, C0606sf c0606sf) {
        ...
        if (cM1662aa == 0) {
            ...
            if (cM1662aa == '&') {
                c0316hm.m1292w(EnumC0709wa.f1701f);
                return;
            }
            if (cM1662aa == '<') {
                c0316hm.m1292w(EnumC0709wa.f1708m);
