...
public final class C0976l implements E<k> {
    ...
    public static final E<k> f2366a = new C0976l();

    /* JADX INFO: renamed from: a */
    public final InterfaceC0969D m2424a(C1004l c1004l, int i, String str, int i2, int i3, int i4, int i5, int i6) {
        k kVar = new k(c1004l, i, i2, i3, i4);
        kVar.d = i5;
        kVar.e = i6;
        if (str != null) {
            kVar.h = str;
