...
public final class C1957F implements InterfaceC1954C {
    ...
    public final void mo4724b(AbstractC1945t abstractC1945t) {
        abstractC1945t.f4444l = this.f4484a;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof C1957F) && this.f4484a == ((C1957F) obj).f4484a;
    }

    public final int hashCode() {
        return C1286l.m3218c(C1286l.m3224i(C1286l.m3224i(0, 0), this.f4484a), 2);
    }

    public final String toString() {
        return String.format("channel(%d)", Integer.valueOf(this.f4484a));
    }
}
