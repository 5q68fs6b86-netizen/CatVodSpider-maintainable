...
/* JADX INFO: renamed from: com.github.catvod.spider.support.p001A.C */
...
public class DialogInterfaceOnClickListenerC0079C implements DialogInterface.OnClickListener {
    ...
    public void onClick(DialogInterface dialogInterface, int i) {
        ...
        try {
            ...
            jSONObject.put("baiduThread", str);
            C2268k.m6168c(fileM6169c, jSONObject.toString());
            Log.i("Config", "配置已保存到config.json, baiduThread: " + str);
            C2256I.m6113i("百度线程已设置: " + str);
