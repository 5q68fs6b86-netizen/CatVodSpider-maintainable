...
/* JADX INFO: renamed from: com.github.catvod.spider.support.p001A.B */
...
public class DialogInterfaceOnClickListenerC0078B implements DialogInterface.OnClickListener {
    ...
    public void onClick(DialogInterface dialogInterface, int i) {
        ...
        try {
            ...
            jSONObject.put("baiduQuality", str);
            C2268k.m6168c(fileM6169c, jSONObject.toString());
            Log.i("Config", "配置已保存到config.json, baiduQuality: " + str);
            C2256I.m6113i("百度画质已更新: " + str);
