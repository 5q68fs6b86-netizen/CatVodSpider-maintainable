...
/* JADX INFO: renamed from: com.github.catvod.spider.support.p107M.۟۟ۤۧ۠, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C2605 {

    /* JADX INFO: renamed from: ۣۡۤۡ, reason: not valid java name and contains not printable characters */
    public static int f6143 = -445;

    /* JADX INFO: renamed from: ۟ۥۥۥ, reason: not valid java name and contains not printable characters */
    public static String m6737(short[] sArr, int i, int i2, int i3) {
