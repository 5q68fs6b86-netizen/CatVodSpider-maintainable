...
final class C1201W extends AbstractC1204Z {
    public C1201W(AbstractC1193N abstractC1193N) {
    ...
    public final boolean mo2996a(C1053l c1053l, C1053l c1053l2) {
        ...
        do {
            c1053l2 = c1053l2.m2709f0();
            if (c1053l2 == null) {
                return false;
            }
            if (this.f2874a.mo2996a(c1053l, c1053l2)) {
                return true;
            }
        } while (c1053l2 != c1053l);
        return false;
    }
