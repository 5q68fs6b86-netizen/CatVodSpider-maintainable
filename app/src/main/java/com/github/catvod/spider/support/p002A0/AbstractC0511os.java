...
public abstract class AbstractC0511os {
    ...
    public static final Pattern f1349a = Pattern.compile(".*,(.+?)$");

    /* JADX INFO: renamed from: b */
    public static final Pattern f1350b = Pattern.compile("group-title=\"(.*?)\"");

    /* JADX INFO: renamed from: c */
    public static String m1505c(String str, Pattern pattern) {
        Matcher matcher = pattern.matcher(str);
        if (matcher.find()) {
            return matcher.group(1);
        }
        return pattern.pattern().equals(f1350b.pattern()) ? "未分组" : "未命名";
    }

    /* JADX INFO: renamed from: d */
    public static String m1506d(LinkedHashMap linkedHashMap) {
    ...
    public static void m1507e(LinkedHashMap linkedHashMap, String str) {
        ArrayList arrayList;
        LinkedHashMap linkedHashMap2;
        ArrayList arrayList2;
        String strM1889k = AbstractC0771yi.m1889k(str, null);
        if (strM1889k.startsWith("#EXTM3U")) {
            try {
                BufferedReader bufferedReader = new BufferedReader(new StringReader(strM1889k));
                ...
                while (true) {
                    ...
                    if (!line.equals("") && !line.startsWith("#EXTM3U") && line.startsWith("#EXTINF")) {
                        String strM1505c = m1505c(line, f1349a);
                        String strM1505c2 = m1505c(line, f1350b);
                        String strTrim = bufferedReader.readLine().trim();
                        if (linkedHashMap.containsKey(strM1505c2)) {
                            linkedHashMap2 = (LinkedHashMap) linkedHashMap.get(strM1505c2);
                        } else {
                            LinkedHashMap linkedHashMap4 = new LinkedHashMap();
                            linkedHashMap.put(strM1505c2, linkedHashMap4);
                            linkedHashMap2 = linkedHashMap4;
                        }
                        if (linkedHashMap2 == null || !linkedHashMap2.containsKey(strM1505c)) {
                            ArrayList arrayList3 = new ArrayList();
                            linkedHashMap2.put(strM1505c, arrayList3);
                            arrayList2 = arrayList3;
                        } else {
                            arrayList2 = (ArrayList) linkedHashMap2.get(strM1505c);
                        }
        ...
        try {
            BufferedReader bufferedReader2 = new BufferedReader(new StringReader(strM1889k));
