...
public class C2601 {
    ...
    public static String m6723(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
    ...
    public static int m6724() {
        return 464 ^ C2612.f6150;
    }
}
