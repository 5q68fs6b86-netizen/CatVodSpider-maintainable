...
import com.github.catvod.spider.support.p125j.C2621;
import java.io.ByteArrayOutputStream;

/* JADX INFO: renamed from: com.github.catvod.spider.support.p140z.۟ۦۢۢۦ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C2630 {

    /* JADX INFO: renamed from: ۟۟ۥۢۤ, reason: not valid java name and contains not printable characters */
    public static int f6167 = 611;

    /* JADX INFO: renamed from: ۣ۟ۨۡۤ, reason: not valid java name and contains not printable characters */
    public static String m6830(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
