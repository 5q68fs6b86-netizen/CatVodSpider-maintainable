...
/* JADX INFO: renamed from: com.github.catvod.spider.support.A0.qu */
/* JADX INFO: loaded from: classes.dex */
public static final class C0567qu extends EnumC0416le {
    public C0567qu() {
        super("BeforeHead", 2);
    }
    ...
    public final boolean mo1058a(AbstractC0680uz abstractC0680uz, C0801zl c0801zl) {
        ...
        if (abstractC0680uz.m1744n()) {
            ...
            if (c0708w.f1730d.equals("head")) {
                c0801zl.f1905y = c0801zl.m1935bf(c0708w);
                c0801zl.f1902v = EnumC0416le.f1131f;
                return true;
            }
        }
        if (abstractC0680uz.m1743m() && AbstractC0727ws.m1847i(((C0667um) abstractC0680uz).f1730d, AbstractC0702vu.f1625e)) {
            c0801zl.m1947br("head");
