...
public final class C0954h extends AbstractC0948b {
    ...
    public C0954h(a... aVarArr) {
        this.f2254b = EnumSet.copyOf((Collection) (aVarArr.length > 0 ? Arrays.asList(aVarArr) : Collections.singletonList(a.semiColonRequired)));
    }
