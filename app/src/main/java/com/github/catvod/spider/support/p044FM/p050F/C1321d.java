...
/* JADX INFO: renamed from: com.github.catvod.spider.support.p044FM.p050F.d */
...
public final class C1321d {
    ...
    private static final String[][] f3056b;

    /* JADX INFO: renamed from: c */
    private static final String[][] f3057c;

    /* JADX INFO: renamed from: d */
    private static final String[][] f3058d;

    /* JADX INFO: renamed from: e */
    private static final String[][] f3059e;

    /* JADX INFO: renamed from: f */
    private static final String[][] f3060f;

    /* JADX INFO: renamed from: g */
    private static final String[][] f3061g;

    /* JADX INFO: renamed from: h */
    private static final String[][] f3062h;

    /* JADX INFO: renamed from: i */
    private static final String[][] f3063i;

    /* JADX INFO: renamed from: j */
    private static final String[][] f3064j;
    ...
    static {
        ...
        f3057c = strArr2;
        f3058d = m3315k(strArr2);
        String[][] strArr3 = {new String[]{"\"", "&quot;"}, new String[]{"&", "&amp;"}, new String[]{"<", "&lt;"}, new String[]{">", "&gt;"}};
        f3059e = strArr3;
        f3060f = m3315k(strArr3);
        String[][] strArr4 = {new String[]{"'", "&apos;"}};
        f3061g = strArr4;
        f3062h = m3315k(strArr4);
        String[][] strArr5 = {new String[]{"\b", "\\b"}, new String[]{"\n", "\\n"}, new String[]{"\t", "\\t"}, new String[]{"\f", "\\f"}, new String[]{"\r", "\\r"}};
        f3063i = strArr5;
        f3064j = m3315k(strArr5);
    }

    /* JADX INFO: renamed from: a */
    public static String[][] m3305a() {
        return (String[][]) f3061g.clone();
    }

    /* JADX INFO: renamed from: b */
    public static String[][] m3306b() {
        return (String[][]) f3062h.clone();
    }

    /* JADX INFO: renamed from: c */
    public static String[][] m3307c() {
        return (String[][]) f3059e.clone();
    }

    /* JADX INFO: renamed from: d */
    public static String[][] m3308d() {
        return (String[][]) f3060f.clone();
    }

    /* JADX INFO: renamed from: e */
    public static String[][] m3309e() {
        return (String[][]) f3057c.clone();
    }

    /* JADX INFO: renamed from: f */
    public static String[][] m3310f() {
        return (String[][]) f3058d.clone();
    }

    /* JADX INFO: renamed from: g */
    public static String[][] m3311g() {
        return (String[][]) f3055a.clone();
    }

    /* JADX INFO: renamed from: h */
    public static String[][] m3312h() {
        return (String[][]) f3056b.clone();
    }

    /* JADX INFO: renamed from: i */
    public static String[][] m3313i() {
        return (String[][]) f3063i.clone();
    }

    /* JADX INFO: renamed from: j */
    public static String[][] m3314j() {
        return (String[][]) f3064j.clone();
    }

    /* JADX INFO: renamed from: k */
    public static String[][] m3315k(String[][] strArr) {
