...
/* JADX INFO: renamed from: com.github.catvod.spider.support.p001A.f */
/* JADX INFO: loaded from: classes.dex */
public class DialogInterfaceOnClickListenerC0093f implements DialogInterface.OnClickListener {
    ...
    public void onClick(DialogInterface dialogInterface, int i) {
        ...
        try {
            ...
            jSONObject.put("quarkThread", str);
            C2268k.m6168c(fileM6169c, jSONObject.toString());
            Log.i("Config", "配置已保存到config.json, quarkThread: " + str);
            C2256I.m6113i("夸克线程已设置: " + str);
