...
public class C2619 {
    ...
    public static String m6785(short[] sArr, int i, int i2, int i3) {
    ...
    public static int m6786() {
        return (-659) ^ C2623.f6160;
    }
}
