...
public class C2607 {
    ...
    public static String m6747(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
