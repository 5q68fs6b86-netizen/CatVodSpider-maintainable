...
public class App3Q extends Spider {
    ...
    private static final String f45e = "SF-C3B2B41F6EFFFF9869176CF68F6790E8F07506FC88632C94B4F5F0430D5498CA";

    /* JADX INFO: renamed from: f */
    private static final String f46f = "com.sunshine.tv";

    /* JADX INFO: renamed from: g */
    private static final String f47g = "SK-thanks";

    /* JADX INFO: renamed from: h */
    private static final String f48h = "4";

    /* JADX INFO: renamed from: d */
    private static final Random f44d = new Random();

    /* JADX INFO: renamed from: a */
    private String m394a(String str) {
        try {
            return new JSONObject(OkHttp.string(this.f49a + str, m395b())).toString();
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
    ...
    /* JADX INFO: renamed from: b */
    private HashMap<String, String> m395b() {
        String upperCase;
        ...
        String str2 = f46f;
        map.put("x-aid", str2);
        map.put("x-time", this.f50b);
        map.put("x-nonc", this.f51c);
        try {
            byte[] bArrDigest = MessageDigest.getInstance("SHA-256").digest(String.format("finger=%s&id=%s&nonce=%s&sk=%s&time=%s&v=%s", f45e, str2, this.f51c, f47g, this.f50b, str).getBytes());
    ...
    /* JADX INFO: renamed from: c */
    private String m396c(String str) {
        try {
    ...
    public String detailContent(List<String> list) {
        Vod c2194e = new Vod();
        try {
            JSONObject jSONObject = new JSONObject(m394a("/api.php/app/vod/get_detail?vod_id=" + list.get(0)));
    ...
    public String homeContent(boolean z) throws JSONException {
        ...
        JSONObject jSONObject = new JSONObject(m394a("/api.php/app/index/home")).getJSONObject("data");
    ...
    public void init(Context context, String str) {
        if (str == null || str.isEmpty()) {
            str = "https://asd123sx23xdacsx.top";
        }
        this.f49a = str;
        this.f50b = String.valueOf(System.currentTimeMillis() / 1000);
        this.f51c = String.valueOf(f44d.nextInt(999) + 1);
    }
    ...
    public String playerContent(String str, String str2, List<String> list) {
        try {
            ...
            for (int i = 0; i < 3; i++) {
                String strM6073l = OkHttp.string(this.f49a + "/api.php/app/decode/url/?url=" + URLEncoder.encode(strTrim, "UTF-8") + "&vodFrom=" + strTrim2 + "", m395b());
                if (strM6073l != null && !strM6073l.trim().isEmpty()) {
                    ...
                    if (jSONObject.optInt("code", -1) == 2 && jSONObject.has("challenge")) {
                        ...
                        if (!strTrim3.isEmpty()) {
                            String strM396c = m396c(strTrim3);
                            if (!strM396c.trim().isEmpty()) {
                                String str4 = "&token=" + strM396c;
                            }
                        }
                    }
    ...
    public String searchContent(String str, boolean z) {
        JSONArray jSONArrayOptJSONArray = new JSONObject(m394a("/api.php/app/search/index?wd=" + URLEncoder.encode(str) + "&page=1&limit=15")).optJSONArray("data");
        new ArrayList();
