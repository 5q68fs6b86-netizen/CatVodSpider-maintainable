...
/* JADX INFO: renamed from: com.github.catvod.spider.support.p001A.X */
/* JADX INFO: loaded from: classes.dex */
public class DialogInterfaceOnClickListenerC0081X implements DialogInterface.OnClickListener {
    ...
    public void onClick(DialogInterface dialogInterface, int i) {
        ...
        try {
            ...
            jSONObject.put("xunleiThread", str);
            C2268k.m6168c(fileM6169c, jSONObject.toString());
            Log.i("Config", "配置已保存到config.json, xunleiThread: " + str);
            C2256I.m6113i("迅雷线程已设置: " + str);
            dialogInterface.dismiss();
        } catch (Exception e) {
            C2256I.m6113i("线程设置失败: " + e);
