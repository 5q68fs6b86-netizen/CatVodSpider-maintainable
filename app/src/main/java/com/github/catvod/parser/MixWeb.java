...
public class MixWeb {
    ...
    public static HashMap f35b = null;
    ...
    public static JSONObject parse(LinkedHashMap<String, HashMap<String, String>> linkedHashMap, String str, String str2, String str3) {
        try {
                ...
                for (String str4 : linkedHashMap.keySet()) {
                    ...
                    if (map.get("type").equals("0")) {
                        ...
                        for (int i = 0; i < jSONArray.length(); i++) {
                            ...
                            ArrayList arrayList = (ArrayList) f35b.get(string);
                            if (arrayList == null) {
                                arrayList = new ArrayList();
                                f35b.put(string, arrayList);
                            }
                            arrayList.add(str4);
                        }
                    }
            ...
            ArrayList arrayList3 = (ArrayList) f35b.get(str2);
            if (arrayList3 == null || arrayList3.isEmpty()) {
                ...
                for (int i2 = 0; i2 < arrayList3.size(); i2++) {
                    HashMap<String, String> map3 = linkedHashMap.get((String) arrayList3.get(i2));
            ...
            if (!arrayList2.isEmpty()) {
                f34a.put(str2, arrayList2);
            }
            if (!arrayList2.isEmpty()) {
                JSONObject jSONObject = new JSONObject();
                jSONObject.put("url", "proxy://do=parseWeb&flag=" + str2 + "&url=" + Base64.encodeToString(str3.getBytes(), 10));
                jSONObject.put("parse", 1);
                jSONObject.put("ua", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.0.0 Safari/537.36 Edg/133.0.0.0");
                return jSONObject;
            }
        } catch (Throwable th) {
            SpiderDebug.log(th);
