...
public class MixDemo {
    ...
    public static final HashMap f32a = new HashMap();

    /* JADX INFO: renamed from: b */
    public static HashMap f33b = null;

    /* JADX INFO: renamed from: c */
    public static String m383c(String str, String str2) {
        int iIndexOf;
    ...
    public static JSONObject parse(LinkedHashMap<String, HashMap<String, String>> linkedHashMap, String str, String str2, String str3) {
        try {
                    ...
                    if (str5.equals("1") || str5.equals("0")) {
                        try {
                            ...
                            for (int i = 0; i < jSONArray.length(); i++) {
                                ...
                                ArrayList arrayList = (ArrayList) f33b.get(string);
                                if (arrayList == null) {
                                    arrayList = new ArrayList();
                                    f33b.put(string, arrayList);
                                }
                                arrayList.add(str4);
                            }
            ...
            ArrayList arrayList3 = (ArrayList) f33b.get(str2);
            if (arrayList3 == null || arrayList3.isEmpty()) {
                for (String str6 : linkedHashMap.keySet()) {
                    HashMap<String, String> map2 = linkedHashMap.get(str6);
                    String str7 = map2.get("type");
                    if (str7.equals("1")) {
                        linkedHashMap2.put(str6, m383c(map2.get("url"), map2.get("ext")));
                ...
                for (int i2 = 0; i2 < arrayList3.size(); i2++) {
                    ...
                    if (str9.equals("1")) {
                        linkedHashMap2.put(str8, m383c(map3.get("url"), map3.get("ext")));
