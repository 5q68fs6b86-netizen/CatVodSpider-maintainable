...
public final class DramaDetailProto {
    ...
    /* JADX INFO: renamed from: internal_static_com_base_model_proto_DramaDetailBeanPage_descriptor */
    private static final Descriptors.Descriptor f9xa4f59c25;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_DramaDetailBeanPage_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f10x24eccda3;
    private static final Descriptors.Descriptor internal_static_com_base_model_proto_DramaDetailBean_descriptor;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_DramaDetailBean_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f11x60525bb2;
    ...
    public final class DramaDetailBean extends GeneratedMessage implements DramaDetailBeanOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements DramaDetailBeanOrBuilder {
            ...
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return DramaDetailProto.f11x60525bb2.ensureFieldAccessorsInitialized(DramaDetailBean.class, Builder.class);
            }
                        ...
                        try {
                            ...
                            switch (tag) {
                                ...
                                case 74:
                                    ...
                                    C2137a.saveName(stringRequireUtf8);
                                    this.name_ = stringRequireUtf8;
                                    this.bitField0_ |= 256;
                                    continue;
                                case 85:
        ...
        public int hashCode() {
            ...
            if (hasCoverImage()) {
                iHashCode = getCoverImage().hashCode() + C0082a.m800a(iHashCode, 37, 2, 53);
            }
            int iHashCode2 = getVodPubdate().hashCode() + ((((Internal.hashBoolean(getIsEnd()) + ((((getRemark().hashCode() + ((((getActor().hashCode() + ((((getConfig().hashCode() + ((((getKeyword().hashCode() + ((((getHitsMonth() + ((((getHitsWeek() + ((((getHitsDay() + ((((getHits() + ((((getYear() + ((((Internal.hashLong(getUpdateTime()) + ((((getCateType1() + ((((getCateType2() + ((((getType() + ((((getTag().hashCode() + ((((getDirector().hashCode() + ((((getStarsCount() + ((((Float.floatToIntBits(getStars()) + ((((getName().hashCode() + ((((getLike() + ((((getBrief().hashCode() + ((((getIntro().hashCode() + ((((getFavoriteId() + ((((getId() + ((((Internal.hashLong(getCreateTime()) + C0082a.m800a(iHashCode, 37, 3, 53)) * 37) + 4) * 53)) * 37) + 5) * 53)) * 37) + 6) * 53)) * 37) + 7) * 53)) * 37) + 8) * 53)) * 37) + 9) * 53)) * 37) + 10) * 53)) * 37) + 11) * 53)) * 37) + 12) * 53)) * 37) + 13) * 53)) * 37) + 14) * 53)) * 37) + 15) * 53)) * 37) + 16) * 53)) * 37) + 17) * 53)) * 37) + 18) * 53)) * 37) + 19) * 53)) * 37) + 20) * 53)) * 37) + 21) * 53)) * 37) + 22) * 53)) * 37) + 23) * 53)) * 37) + 24) * 53)) * 37) + 25) * 53)) * 37) + 26) * 53)) * 37) + 27) * 53)) * 37) + 28) * 53);
            if (getVideosCount() > 0) {
                iHashCode2 = C0082a.m800a(iHashCode2, 37, 29, 53) + getVideosList().hashCode();
            }
            if (getDownloadsCount() > 0) {
                iHashCode2 = C0082a.m800a(iHashCode2, 37, 30, 53) + getDownloadsList().hashCode();
            }
            if (getUserLikesCount() > 0) {
                iHashCode2 = C0082a.m800a(iHashCode2, 37, 31, 53) + getUserLikesList().hashCode();
            }
            if (getFavoriteCount() > 0) {
                iHashCode2 = C0082a.m800a(iHashCode2, 37, 32, 53) + getFavoriteList().hashCode();
            }
            int iHashCode3 = getUnknownFields().hashCode() + ((Internal.hashBoolean(getHot()) + ((((Internal.hashBoolean(getVip()) + ((((Internal.hashBoolean(getSerial()) + ((((Internal.hashBoolean(getSeason()) + C0082a.m800a(iHashCode2, 37, 33, 53)) * 37) + 34) * 53)) * 37) + 35) * 53)) * 37) + 36) * 53)) * 29);
    ...
    public final class DramaDetailBeanPage extends GeneratedMessage implements DramaDetailBeanPageOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements DramaDetailBeanPageOrBuilder {
            ...
            public static final Descriptors.Descriptor getDescriptor() {
                return DramaDetailProto.f9xa4f59c25;
            }
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return DramaDetailProto.f10x24eccda3.ensureFieldAccessorsInitialized(DramaDetailBeanPage.class, Builder.class);
            }
        ...
        public int hashCode() {
            ...
            if (getDramaDetailBeanCount() > 0) {
                iHashCode = C0082a.m800a(iHashCode, 37, 1, 53) + getDramaDetailBeanList().hashCode();
            }
    ...
    static {
        ...
        f11x60525bb2 = new GeneratedMessage.FieldAccessorTable(descriptor2, new String[]{"Area", "CoverImage", "CreateTime", "Id", "FavoriteId", "Intro", "Brief", "Like", "Name", "Stars", "StarsCount", "Director", "Tag", "Type", "CateType2", "CateType1", "UpdateTime", "Year", "Hits", "HitsDay", "HitsWeek", "HitsMonth", "Keyword", "Config", "Actor", "Remark", "IsEnd", "VodPubdate", "Videos", "Downloads", "UserLikes", "Favorite", "Season", "Serial", "Vip", "Hot"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        f9xa4f59c25 = descriptor3;
        f10x24eccda3 = new GeneratedMessage.FieldAccessorTable(descriptor3, new String[]{"DramaDetailBean"});
