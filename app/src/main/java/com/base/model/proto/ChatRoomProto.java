...
public final class ChatRoomProto {
    ...
    /* JADX INFO: renamed from: internal_static_com_base_model_proto_ChatRoomAdd_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f2xbcb9ff0c;
    private static final Descriptors.Descriptor internal_static_com_base_model_proto_ChatRoomPage_descriptor;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_ChatRoomPage_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f3xe03b2fc;
    private static final Descriptors.Descriptor internal_static_com_base_model_proto_ChatRoomReq_descriptor;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_ChatRoomReq_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f4x7b6c3bef;
    private static final Descriptors.Descriptor internal_static_com_base_model_proto_ChatRoomUpdate_descriptor;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_ChatRoomUpdate_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f5xc4bb12c2;
    private static final Descriptors.Descriptor internal_static_com_base_model_proto_ChatRoomVO_descriptor;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_ChatRoomVO_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f6x9fe27272;
    ...
    public final class ChatRoomAdd extends GeneratedMessage implements ChatRoomAddOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements ChatRoomAddOrBuilder {
            ...
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ChatRoomProto.f2xbcb9ff0c.ensureFieldAccessorsInitialized(ChatRoomAdd.class, Builder.class);
            }
    ...
    public final class ChatRoomPage extends GeneratedMessage implements ChatRoomPageOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements ChatRoomPageOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ChatRoomProto.f3xe03b2fc.ensureFieldAccessorsInitialized(ChatRoomPage.class, Builder.class);
            }
        ...
        public int hashCode() {
            ...
            if (getChatRoomCount() > 0) {
                iHashCode = C0082a.m800a(iHashCode, 37, 1, 53) + getChatRoomList().hashCode();
            }
            int iHashCode2 = getUnknownFields().hashCode() + ((Internal.hashLong(getTotal()) + ((((getPageSize() + ((((getPageNum() + C0082a.m800a(iHashCode, 37, 2, 53)) * 37) + 3) * 53)) * 37) + 4) * 53)) * 29);
    ...
    public final class ChatRoomReq extends GeneratedMessage implements ChatRoomReqOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements ChatRoomReqOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ChatRoomProto.f4x7b6c3bef.ensureFieldAccessorsInitialized(ChatRoomReq.class, Builder.class);
            }
    ...
    public final class ChatRoomUpdate extends GeneratedMessage implements ChatRoomUpdateOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements ChatRoomUpdateOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ChatRoomProto.f5xc4bb12c2.ensureFieldAccessorsInitialized(ChatRoomUpdate.class, Builder.class);
            }
    ...
    public final class ChatRoomVO extends GeneratedMessage implements ChatRoomVOOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements ChatRoomVOOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ChatRoomProto.f6x9fe27272.ensureFieldAccessorsInitialized(ChatRoomVO.class, Builder.class);
            }
        ...
        public int hashCode() {
            ...
            if (getUserListCount() > 0) {
                iHashBoolean = C0082a.m800a(iHashBoolean, 37, 11, 53) + getUserListList().hashCode();
            }
            int iHashCode = getUnknownFields().hashCode() + ((getTotalNumber() + ((((Internal.hashLong(getVideoAdjustTime()) + ((((Internal.hashLong(getVideoProgress()) + ((((getUserHeadImg().hashCode() + ((((getUserName().hashCode() + C0082a.m800a(iHashBoolean, 37, 12, 53)) * 37) + 13) * 53)) * 37) + 14) * 53)) * 37) + 15) * 53)) * 37) + 16) * 53)) * 29);
            this.memoizedHashCode = iHashCode;
            return iHashCode;
        }
    ...
    static {
        ...
        f2xbcb9ff0c = new GeneratedMessage.FieldAccessorTable(descriptor2, new String[]{"RoomName", "RoomDesc", "RoomPwd", "VideoId", "VideoCover", "CreatorId", "PlaySource", "VideoNum", "UserName", "UserHeadImg"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        internal_static_com_base_model_proto_ChatRoomUpdate_descriptor = descriptor3;
        f5xc4bb12c2 = new GeneratedMessage.FieldAccessorTable(descriptor3, new String[]{"RoomId", "RoomName"});
        Descriptors.Descriptor descriptor4 = getDescriptor().getMessageTypes().get(2);
        internal_static_com_base_model_proto_ChatRoomPage_descriptor = descriptor4;
        f3xe03b2fc = new GeneratedMessage.FieldAccessorTable(descriptor4, new String[]{"ChatRoom", "PageNum", "PageSize", "Total"});
        Descriptors.Descriptor descriptor5 = getDescriptor().getMessageTypes().get(3);
        internal_static_com_base_model_proto_ChatRoomVO_descriptor = descriptor5;
        f6x9fe27272 = new GeneratedMessage.FieldAccessorTable(descriptor5, new String[]{"Id", "RoomName", "RoomDesc", "VideoId", "VideoCover", "CreatorId", "PlaySource", "VideoNum", "OnlineNumber", "HavePwd", "UserList", "UserName", "UserHeadImg", "VideoProgress", "VideoAdjustTime", "TotalNumber"});
        Descriptors.Descriptor descriptor6 = getDescriptor().getMessageTypes().get(4);
        internal_static_com_base_model_proto_ChatRoomReq_descriptor = descriptor6;
        f4x7b6c3bef = new GeneratedMessage.FieldAccessorTable(descriptor6, new String[]{"Id", "CreatorId", "VideoId", "PageNum", "PageSize"});
