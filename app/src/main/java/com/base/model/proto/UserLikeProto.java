...
public final class UserLikeProto {
    ...
    /* JADX INFO: renamed from: internal_static_com_base_model_proto_UserLikeBeanPage_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f27x1d60de9d;
    private static final Descriptors.Descriptor internal_static_com_base_model_proto_UserLikeBean_descriptor;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_UserLikeBean_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f28xe219f9ac;
    ...
    public final class UserLikeBean extends GeneratedMessage implements UserLikeBeanOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements UserLikeBeanOrBuilder {
            ...
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return UserLikeProto.f28xe219f9ac.ensureFieldAccessorsInitialized(UserLikeBean.class, Builder.class);
            }
    ...
    public final class UserLikeBeanPage extends GeneratedMessage implements UserLikeBeanPageOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements UserLikeBeanPageOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return UserLikeProto.f27x1d60de9d.ensureFieldAccessorsInitialized(UserLikeBeanPage.class, Builder.class);
            }
        ...
        public int hashCode() {
            ...
            if (getUserLikeBeanCount() > 0) {
                iHashCode = C0082a.m800a(iHashCode, 37, 1, 53) + getUserLikeBeanList().hashCode();
            }
    ...
    static {
        ...
        f28xe219f9ac = new GeneratedMessage.FieldAccessorTable(descriptor2, new String[]{"Id", "UserId", "DramaId", "CreateTime"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        internal_static_com_base_model_proto_UserLikeBeanPage_descriptor = descriptor3;
        f27x1d60de9d = new GeneratedMessage.FieldAccessorTable(descriptor3, new String[]{"UserLikeBean"});
