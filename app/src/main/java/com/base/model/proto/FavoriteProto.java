...
public final class FavoriteProto {
    ...
    /* JADX INFO: renamed from: internal_static_com_base_model_proto_FavoriteBeanPage_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f15x1b9156c3;
    private static final Descriptors.Descriptor internal_static_com_base_model_proto_FavoriteBean_descriptor;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_FavoriteBean_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f16xafe874d2;
    ...
    public final class FavoriteBean extends GeneratedMessage implements FavoriteBeanOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements FavoriteBeanOrBuilder {
            ...
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return FavoriteProto.f16xafe874d2.ensureFieldAccessorsInitialized(FavoriteBean.class, Builder.class);
            }
    ...
    public final class FavoriteBeanPage extends GeneratedMessage implements FavoriteBeanPageOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements FavoriteBeanPageOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return FavoriteProto.f15x1b9156c3.ensureFieldAccessorsInitialized(FavoriteBeanPage.class, Builder.class);
            }
        ...
        public int hashCode() {
            ...
            if (getFavoriteBeanCount() > 0) {
                iHashCode = C0082a.m800a(iHashCode, 37, 1, 53) + getFavoriteBeanList().hashCode();
            }
    ...
    static {
        ...
        f16xafe874d2 = new GeneratedMessage.FieldAccessorTable(descriptor2, new String[]{"Id", "UserId", "VodId", "CreateTime", "VodName", "CoverUrl", "Stars", "StarsCount", "Year", "Area", "Actor", "Type", "CateType2", "Ext", "Director", "Tag", "Clazz"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        internal_static_com_base_model_proto_FavoriteBeanPage_descriptor = descriptor3;
        f15x1b9156c3 = new GeneratedMessage.FieldAccessorTable(descriptor3, new String[]{"FavoriteBean"});
