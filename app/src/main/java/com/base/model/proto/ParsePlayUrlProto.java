...
public final class ParsePlayUrlProto {
    ...
    /* JADX INFO: renamed from: internal_static_com_base_model_proto_ParsePlayUrlBean_HeadersEntry_descriptor */
    private static final Descriptors.Descriptor f20xc8ed4ae9;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_ParsePlayUrlBean_HeadersEntry_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f21x69bb7867;
    private static final Descriptors.Descriptor internal_static_com_base_model_proto_ParsePlayUrlBean_descriptor;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_ParsePlayUrlBean_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f22x17b6c86;
    ...
    public final class ParsePlayUrlBean extends GeneratedMessage implements ParsePlayUrlBeanOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements ParsePlayUrlBeanOrBuilder {
            ...
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return ParsePlayUrlProto.f22x17b6c86.ensureFieldAccessorsInitialized(ParsePlayUrlBean.class, Builder.class);
            }
            ...
            public MapFieldReflectionAccessor internalGetMapFieldReflection(int i) {
                ...
                throw new RuntimeException(C0082a.m825c("Invalid map field number: ", i));
            }
        ...
        final class HeadersDefaultEntryHolder {
            ...
            static {
                Descriptors.Descriptor descriptor = ParsePlayUrlProto.f20xc8ed4ae9;
        ...
        public int hashCode() {
            ...
            if (!internalGetHeaders().getMap().isEmpty()) {
                direct = internalGetHeaders().hashCode() + C0082a.m800a(direct, 37, 6, 53);
            }
            int iHashCode = getUnknownFields().hashCode() + ((getMsg().hashCode() + ((((getIosPlayCore().hashCode() + ((((getAndroidPlayCore().hashCode() + C0082a.m800a(direct, 37, 7, 53)) * 37) + 8) * 53)) * 37) + 9) * 53)) * 29);
    ...
    static {
        ...
        f22x17b6c86 = new GeneratedMessage.FieldAccessorTable(descriptor2, new String[]{"PlayUrl", "FitMode", "MirrorMode", "Timeout", "Direct", "Headers", "AndroidPlayCore", "IosPlayCore", "Msg"});
        Descriptors.Descriptor descriptor3 = descriptor2.getNestedTypes().get(0);
        f20xc8ed4ae9 = descriptor3;
        f21x69bb7867 = new GeneratedMessage.FieldAccessorTable(descriptor3, new String[]{"Key", "Value"});
