...
public final class DramaProto {
    ...
    /* JADX INFO: renamed from: internal_static_com_base_model_proto_DramaBeanPage_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f12x841961f4;
    private static final Descriptors.Descriptor internal_static_com_base_model_proto_DramaBean_descriptor;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_DramaBean_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f13xf94fc083;
    ...
    public final class DramaBean extends GeneratedMessage implements DramaBeanOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements DramaBeanOrBuilder {
            ...
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return DramaProto.f13xf94fc083.ensureFieldAccessorsInitialized(DramaBean.class, Builder.class);
            }
    ...
    public final class DramaBeanPage extends GeneratedMessage implements DramaBeanPageOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements DramaBeanPageOrBuilder {
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return DramaProto.f12x841961f4.ensureFieldAccessorsInitialized(DramaBeanPage.class, Builder.class);
            }
        ...
        public int hashCode() {
            ...
            if (getDramaBeanCount() > 0) {
                iHashCode = C0082a.m800a(iHashCode, 37, 1, 53) + getDramaBeanList().hashCode();
            }
            int iHashCode2 = getUnknownFields().hashCode() + ((getTotal() + C0082a.m800a(iHashCode, 37, 16, 53)) * 29);
            this.memoizedHashCode = iHashCode2;
            return iHashCode2;
        }
    ...
    static {
        ...
        f13xf94fc083 = new GeneratedMessage.FieldAccessorTable(descriptor2, new String[]{"Area", "CoverImage", "Id", "Brief", "Name", "Stars", "Director", "Type", "CateType2", "UpdateTime", "VodPubdate", "Actor", "Remark", "Year", "Clazz"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        internal_static_com_base_model_proto_DramaBeanPage_descriptor = descriptor3;
        f12x841961f4 = new GeneratedMessage.FieldAccessorTable(descriptor3, new String[]{"DramaBean", "Total"});
