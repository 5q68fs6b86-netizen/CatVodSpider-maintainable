...
public final class DramaVideoProto {
    ...
    /* JADX INFO: renamed from: internal_static_com_base_model_proto_DramaVideoBean_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f14xca51189a;
    ...
    public final class DramaVideoBean extends GeneratedMessage implements DramaVideoBeanOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements DramaVideoBeanOrBuilder {
            ...
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return DramaVideoProto.f14xca51189a.ensureFieldAccessorsInitialized(DramaVideoBean.class, Builder.class);
            }
    ...
    static {
        ...
        f14xca51189a = new GeneratedMessage.FieldAccessorTable(descriptor2, new String[]{"Id", "Title", "TitleOld", "Path", "Size", "Time", "Format", "Type", "Source", "SourceCn", "SourceOld", "Season", "Episode", "IsVip", "DramaId", "Priority", "ClassType", "Sort"});
