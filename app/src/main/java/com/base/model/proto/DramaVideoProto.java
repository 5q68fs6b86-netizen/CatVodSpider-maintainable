...
public final class DramaVideoProto {
    ...
    public static class DramaVideoBean {

        public static DramaVideoBean parseFrom(byte[] b) { return new DramaVideoBean(); }
        public static DramaVideoBean parseFrom(java.io.InputStream in) { return new DramaVideoBean(); }
        public static DramaVideoBean getDefaultInstance() { return new DramaVideoBean(); }
        public static DramaVideoBeanMsgBuilder newBuilder() { return new DramaVideoBeanMsgBuilder(); }
        public DramaVideoBeanMsgBuilder toBuilder() { return new DramaVideoBeanMsgBuilder(); }
        public byte[] toByteArray() { return new byte[0]; }
        public String getValue() { return ""; }
        public String getUrl() { return ""; }
        public String getMsg() { return ""; }
        ...
        public boolean hasNext() { return false; }
        public boolean getSuccess() { return true; }
        public DramaVideoBean getData() { return this; }
        public DramaVideoBean getResult() { return this; }
        public DramaVideoBean getCoverImage() { return this; }
        public java.util.List getListList() { return java.util.Collections.emptyList(); }
        public java.util.List getItemsList() { return java.util.Collections.emptyList(); }
        public java.util.List getRecordsList() { return java.util.Collections.emptyList(); }
        public java.util.List getDramaListList() { return java.util.Collections.emptyList(); }
        ...
        public java.util.List getVideosList() { return java.util.Collections.emptyList(); }
        public int getListCount() { return 0; }
        public DramaVideoBean getList(int i) { return this; }
        public java.util.Map getHeadersMap() { return java.util.Collections.emptyMap(); }
        public Object getOrDefault(Object k, Object v) { return v; }
        public static final class DramaVideoBeanMsgBuilder {
            public DramaVideoBeanMsgBuilder mergeFrom(byte[] b) { return this; }
            public DramaVideoBeanMsgBuilder setValue(String v) { return this; }
            public DramaVideoBeanMsgBuilder setUrl(String v) { return this; }
            public DramaVideoBeanMsgBuilder setKey(String v) { return this; }
            public DramaVideoBeanMsgBuilder setContent(String v) { return this; }
            public DramaVideoBean build() { return new DramaVideoBean(); }
            public DramaVideoBean buildPartial() { return new DramaVideoBean(); }
        }
