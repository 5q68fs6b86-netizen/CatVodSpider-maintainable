...
public final class NormalTagsProto {
    ...
    /* JADX INFO: renamed from: internal_static_com_base_model_proto_NormalTagsBeanPage_descriptor */
    private static final Descriptors.Descriptor f17x47adca41;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_NormalTagsBeanPage_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f18x13131fbf;
    private static final Descriptors.Descriptor internal_static_com_base_model_proto_NormalTagsBean_descriptor;

    /* JADX INFO: renamed from: internal_static_com_base_model_proto_NormalTagsBean_fieldAccessorTable */
    private static final GeneratedMessage.FieldAccessorTable f19x70ce1bce;
    ...
    public final class NormalTagsBean extends GeneratedMessage implements NormalTagsBeanOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements NormalTagsBeanOrBuilder {
            ...
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return NormalTagsProto.f19x70ce1bce.ensureFieldAccessorsInitialized(NormalTagsBean.class, Builder.class);
            }
        ...
        public int hashCode() {
            ...
            if (getCarouselsCount() > 0) {
                playInterval = getCarouselsList().hashCode() + C0082a.m800a(playInterval, 37, 30, 53);
            }
            if (getSectionsCount() > 0) {
                playInterval = getSectionsList().hashCode() + C0082a.m800a(playInterval, 37, 31, 53);
            }
    ...
    public final class NormalTagsBeanPage extends GeneratedMessage implements NormalTagsBeanPageOrBuilder {
        ...
        public final class Builder extends GeneratedMessage.Builder<Builder> implements NormalTagsBeanPageOrBuilder {
            ...
            public static final Descriptors.Descriptor getDescriptor() {
                return NormalTagsProto.f17x47adca41;
            }
            ...
            @Override // com.google.protobuf.GeneratedMessage.Builder
            public GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
                return NormalTagsProto.f18x13131fbf.ensureFieldAccessorsInitialized(NormalTagsBeanPage.class, Builder.class);
            }
        ...
        public int hashCode() {
            ...
            if (getNormalTagsBeanCount() > 0) {
                iHashCode = C0082a.m800a(iHashCode, 37, 1, 53) + getNormalTagsBeanList().hashCode();
            }
    ...
    static {
        ...
        f19x70ce1bce = new GeneratedMessage.FieldAccessorTable(descriptor2, new String[]{"Id", "Name", "DisplayOrder", "TypeId", "TypeName", "ColumnCount", "CoverAlignment", "ShowRemarks", "ShowSubtitle", "ShowYear", "ShowRating", "ShowCategory", "ShowLanguage", "ShowDecade", "DefaultDecadeDisplay", "ShowRegion", "ShowVersion", "ShowState", "ShowStar", "ShowDirector", "State", "Mode", "MoreText", "FooterListText", "Width", "Height", "BorderRadius", "AutoPlay", "PlayInterval", "Carousels", "Sections"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        f17x47adca41 = descriptor3;
        f18x13131fbf = new GeneratedMessage.FieldAccessorTable(descriptor3, new String[]{"NormalTagsBean"});
